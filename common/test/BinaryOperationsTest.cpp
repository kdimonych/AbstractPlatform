...
inline static constexpr bool StaticOperationsTest(std::integer_sequence<taIndexType, taIndexes...>)
{
...
TYPED_TEST(BinaryOperationsTest, TestMainOperation)
{
  ...
  static_assert(StaticOperationsTest<TType>(std::make_index_sequence<BitSize(TType{})>{}));
